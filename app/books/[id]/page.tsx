  ...
  if (!book) {
    return (
      <div className="flex items-center justify-evenly">
        <p className="font-bold font-mono text-3xl text-justify">
          Book not found
        </p>
      </div>
    );
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="md:flex">
        <div className="md:flex-shrink-0 md:w-1/3 mb-6 md:mb-0 md:mr-6">
          <Image
            src={book.image}
        ...
        <div className="md:w-2/3 mx-6 px-6">
          <h1 className="text-3xl font-bold mb-6">{book.name}</h1>
          <p className="text-gray-600 mb-4">Published: {book.year}</p>
          <p className="mb-6 text-justify">{book.description}</p>
          <Link
            href={book.link}
            prefetch={false}
            target="_blank"
            className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 mr-8"
          >
            Buy Now
          </Link>
          <Link
